                                    ...
                                    <div class="pbmit-border-wrapper">
                                        <div class="pbmit-client-wrapper pbmit-client-with-hover-img">
                                            ...
                                            <div class="pbmit-client-hover-img">
                                                <img src="{{ $client->getImageUrl('preview') }}" class="img-fluid" alt="">
                                            </div>
                            ...
                            <article class="pbmit-client-style-1 swiper-slide">
                                <div class="pbmit-border-wrapper">
                                    <div class="pbmit-client-wrapper pbmit-client-with-hover-img">
                                        ...
                                        <div class="pbmit-client-hover-img">
                                            <img src="{{ asset('assets/images/homepage-3/client/client-global-01.png') }}" class="img-fluid" alt="">

                                        </div>
                                        <div class="pbmit-featured-img-wrapper">
                                            <div class="pbmit-featured-wrapper">
                                                <img src="{{ asset('assets/images/homepage-3/client/client-grey-01.png') }}" class="img-fluid" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <article class="pbmit-client-style-1 swiper-slide">
                                <div class="pbmit-border-wrapper">
                                    <div class="pbmit-client-wrapper pbmit-client-with-hover-img">
                                        <h4 class="pbmit-hide">Client 12</h4>
                                        <div class="pbmit-client-hover-img">
                                            <img src="{{ asset('assets/images/homepage-3/client/client-global-02.png') }}" class="img-fluid" alt="">
                                        </div>
                                        <div class="pbmit-featured-img-wrapper">
                                            <div class="pbmit-featured-wrapper">
                                                <img src="{{ asset('assets/images/homepage-3/client/client-grey-02.png') }}" class="img-fluid" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <article class="pbmit-client-style-1 swiper-slide">
                                <div class="pbmit-border-wrapper">
                                    <div class="pbmit-client-wrapper pbmit-client-with-hover-img">
                                        <h4 class="pbmit-hide">Client 12</h4>
                                        <div class="pbmit-client-hover-img">
                                            <img src="{{ asset('assets/images/homepage-3/client/client-global-03.png') }}" class="img-fluid" alt="">
                                        </div>
                                        <div class="pbmit-featured-img-wrapper">
                                            <div class="pbmit-featured-wrapper">
                                                <img src="{{ asset('assets/images/homepage-3/client/client-grey-03.png') }}" class="img-fluid" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <article class="pbmit-client-style-1 swiper-slide">
                                <div class="pbmit-border-wrapper">
                                    <div class="pbmit-client-wrapper pbmit-client-with-hover-img">
                                        <h4 class="pbmit-hide">Client 12</h4>
                                        <div class="pbmit-client-hover-img">
                                            <img src="{{ asset('assets/images/homepage-3/client/client-global-04.png') }}" class="img-fluid" alt="">
                                        </div>
                                        <div class="pbmit-featured-img-wrapper">
                                            <div class="pbmit-featured-wrapper">
                                                <img src="{{ asset('assets/images/homepage-3/client/client-grey-04.png') }}" class="img-fluid" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <article class="pbmit-client-style-1 swiper-slide">
                                <div class="pbmit-border-wrapper">
                                    <div class="pbmit-client-wrapper pbmit-client-with-hover-img">
                                        <h4 class="pbmit-hide">Client 12</h4>
                                        <div class="pbmit-client-hover-img">
                                            <img src="{{ asset('assets/images/homepage-3/client/client-global-05.png') }}" class="img-fluid" alt="">
                                        </div>
                                        <div class="pbmit-featured-img-wrapper">
                                            <div class="pbmit-featured-wrapper">
                                                <img src="{{ asset('assets/images/homepage-3/client/client-grey-05.png') }}" class="img-fluid" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <article class="pbmit-client-style-1 swiper-slide">
                                <div class="pbmit-border-wrapper">
                                    <div class="pbmit-client-wrapper pbmit-client-with-hover-img">
                                        <h4 class="pbmit-hide">Client 12</h4>
                                        <div class="pbmit-client-hover-img">
                                            <img src="{{ asset('assets/images/homepage-3/client/client-global-06.png') }}" class="img-fluid" alt="">
                                        </div>
                                        <div class="pbmit-featured-img-wrapper">
                                            <div class="pbmit-featured-wrapper">
                                                <img src="{{ asset('assets/images/homepage-3/client/client-grey-06.png') }}" class="img-fluid" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <article class="pbmit-client-style-1 swiper-slide">
                                <div class="pbmit-border-wrapper">
                                    <div class="pbmit-client-wrapper pbmit-client-with-hover-img">
                                        <h4 class="pbmit-hide">Client 12</h4>
                                        <div class="pbmit-client-hover-img">
                                            <img src="{{ asset('assets/images/homepage-3/client/client-global-07.png') }}" class="img-fluid" alt="">
                                        </div>
                                        <div class="pbmit-featured-img-wrapper">
                                            <div class="pbmit-featured-wrapper">
                                                <img src="{{ asset('assets/images/homepage-3/client/client-grey-07.png') }}" class="img-fluid" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <article class="pbmit-client-style-1 swiper-slide">
                                <div class="pbmit-border-wrapper">
                                    <div class="pbmit-client-wrapper pbmit-client-with-hover-img">
                                        <h4 class="pbmit-hide">Client 12</h4>
                                        <div class="pbmit-client-hover-img">
                                            <img src="{{ asset('assets/images/homepage-3/client/client-global-08.png') }}" class="img-fluid" alt="">
                                        </div>
                                        <div class="pbmit-featured-img-wrapper">
                                            <div class="pbmit-featured-wrapper">
                                                <img src="{{ asset('assets/images/homepage-3/client/client-grey-08.png') }}" class="img-fluid" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
