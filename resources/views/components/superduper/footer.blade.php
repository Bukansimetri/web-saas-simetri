    ...
    <div class="pbmit-footer-text-area">
        <div class="container">
            <div class="pbmit-footer-text-inner">
                <div class="row">
                    <div class="col-md-6">
                        <div class="pbmit-footer-copyright-text-area"> Copyright © {{ date('Y') }} <a href="{{ route('home') }}">{{ $generalSettings->brand_name ?? $siteSettings->name ?? config('app.name', 'Simetri') }}</a>, {{ $siteSettings->copyright_text ?? 'All Rights Reserved.' }}</div>
                    </div>
                    <div class="col-md-6">
